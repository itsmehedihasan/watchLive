...
export const els = {
  ...
  addTabPlaylist: $('addTabPlaylist'), addTabChannels: $('addTabChannels'),
  playlistPanel: $('playlistPanel'), playlistList: $('playlistList'), playlistEmpty: $('playlistEmpty'),
  channelListPanel: $('channelListPanel'), channelListFilter: $('channelListFilter'),
  channelListItems: $('channelListItems'), channelListEmpty: $('channelListEmpty'),
